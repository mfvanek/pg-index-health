...
import static io.github.mfvanek.pg.index.check.cluster.UnusedIndexesCheckOnCluster.getLastStatsResetDateLogMessage;
import static io.github.mfvanek.pg.index.check.cluster.UnusedIndexesCheckOnCluster.getResultAsIntersection;
...
class UnusedIndexesCheckOnClusterTest extends DatabaseAwareTestBase {
    ...
    private final DatabaseCheck<UnusedIndex> check;
