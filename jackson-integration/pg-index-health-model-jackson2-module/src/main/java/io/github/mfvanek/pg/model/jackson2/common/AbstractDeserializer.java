...
package io.github.mfvanek.pg.model.jackson2.common;
...
public abstract class AbstractDeserializer<T> extends JsonDeserializer<T> {
     ...
     * @throws JsonMappingException if the field is missing or explicitly null
     */
     ...
     * @throws JsonMappingException if the field is missing, null, or not a string
     */
     ...
     * @throws JsonMappingException if the field is missing, null, or not a boolean
     */
     ...
     * @throws JsonMappingException if the field is missing, null, or not a long
     */
     ...
     * @throws JsonMappingException if the field is missing, null, or not a double
     */
