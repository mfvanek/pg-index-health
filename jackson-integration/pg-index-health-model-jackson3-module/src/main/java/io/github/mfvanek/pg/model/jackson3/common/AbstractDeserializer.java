...
/**
 * Base class for custom Jackson 3 deserializers. Provides utility methods for
...
public abstract class AbstractDeserializer<T> extends ValueDeserializer<T> {
     ...
     * {@code rootNode}, ensuring that it exists and is not null.
     * <p>
     * If the field is missing or explicitly null, this method reports an
     ...
     * @throws MismatchedInputException if the field is missing or explicitly null
     */
     ...
     * <p>
     * This method ensures the field exists, is not null, and is of textual type. If the field
     * is missing, null, or not a string, an input mismatch is reported to the
     * {@code DeserializationContext}, resulting in a {@code MismatchedInputException}.
     *
     * @param ctxt      the deserialization context used for error reporting
     ...
     * @throws MismatchedInputException if the field is missing, null, or not a string
     */
     ...
     * <p>
     * This method ensures the field exists, is not null, and is of boolean type.
     * If the field is missing, null, or not a boolean, an input mismatch is
     * reported to the {@link DeserializationContext}, resulting in a {@link MismatchedInputException}.
     *
     * @param ctxt      the deserialization context used for error reporting
     * @param rootNode  the root JSON node containing the field
     * @param fieldName the name of the field to retrieve from {@code rootNode}
     * @return the value of the specified field as a {@code boolean}
     * @throws MismatchedInputException if the field is missing, null, or not a boolean
     */
     ...
     * <p>
     * This method ensures the field exists, is not null, and is of type long.
     * If the field is missing, null, or not a long, an input mismatch is reported
     * to the {@link DeserializationContext}, resulting in a {@link MismatchedInputException}.
     *
     * @param ctxt      the deserialization context used for error reporting
     * @param rootNode  the root JSON node containing the field
     * @param fieldName the name of the field to retrieve from {@code rootNode}
     * @return the value of the specified field as a {@code long}
     * @throws MismatchedInputException if the field is missing, null, or not a long
     */
     ...
     * <p>
     * This method ensures the field exists, is not null, and is of type double.
     * If the field is missing, null, or not a double, an input mismatch is
     * reported to the {@code DeserializationContext}, resulting in a {@code MismatchedInputException}.
     *
     * @param ctxt      the deserialization context used for error reporting
     * @param rootNode  the root JSON node containing the field
     * @param fieldName the name of the field to retrieve from {@code rootNode}
     * @return the value of the specified field as a {@code double}
     * @throws MismatchedInputException if the field is missing, null, or not a double
     */
