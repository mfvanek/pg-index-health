...
class IndexWithBloatSerializerTest extends ObjectMapperTestBase {
    ...
    void serializationShouldWork() throws IOException {
        final IndexWithBloat original = IndexWithBloat.of("t1", "i1", 100L, 40L, 40.0);
        assertThat(objectMapper.writeValueAsString(original))
            .isEqualTo("{\"index\":{\"tableName\":\"t1\",\"indexName\":\"i1\",\"indexSizeInBytes\":100},\"bloatSizeInBytes\":40,\"bloatPercentage\":40.0}");
