...
class ObjectsWithUpperCaseNamesCheckOnHostTest extends DatabaseAwareTestBase {

    private final DatabaseCheckOnHost<@NonNull AnyObject> check = new ObjectsWithUpperCaseNamesCheckOnHost(getPgConnection());
