...
class ColumnsWithBlobTypeCheckOnHostTest extends DatabaseAwareTestBase {

    private final DatabaseCheckOnHost<@NonNull ColumnWithType> check = new ColumnsWithBlobTypeCheckOnHost(getPgConnection());
