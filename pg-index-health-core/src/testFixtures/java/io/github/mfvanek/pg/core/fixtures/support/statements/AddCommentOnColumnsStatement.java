...
public class AddCommentOnColumnsStatement extends AbstractDbStatement {
    ...
    protected List<String> getSqlToExecute() {
        return List.of(
            ...
            "comment on column {schemaName}.gender is 'Customer''s gender';",
            "comment on column {schemaName}.home_address is 'Customer''s home address';",
            "comment on column {schemaName}.contact_person is 'Emergency contact person';",
            "comment on column {schemaName}.nickname is 'Customer''s pseudonym, alternative name';",
            "comment on column {schemaName}.safe_word is 'Customer''s home address';",
