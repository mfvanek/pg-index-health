...
class TablesWhereAllColumnsNullableExceptPrimaryKeyCheckOnClusterTest extends DatabaseAwareTestBase {

    private final DatabaseCheckOnCluster<@NonNull Table> check = new TablesWhereAllColumnsNullableExceptPrimaryKeyCheckOnCluster(getHaPgConnection());
